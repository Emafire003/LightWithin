...
public class LuxcognitaScreenV1 extends Screen{
    private static final long MIN_LOAD_TIME_MS = 60000L;
    private final long loadStartTime;

    public LuxcognitaScreenV1(Text title) {
        super(title);
    ...
    public void lightTargetIngredientAction(ButtonWidget buttonWidget) {
        ...
        //TODO debug
        MinecraftClient.getInstance().setScreen(LuxdialogueScreens.LUXDIALOGUE_SCREENS.get("default"));
        this.close();
    }
