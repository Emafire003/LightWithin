    ...
    void preHudRender(RenderEvent re) {
        MSAAFramebuffer.use(MSAAFramebuffer.MAX_SAMPLES, () -> {
            ...
            if(MinecraftClient.getInstance().options.getPerspective().equals(Perspective.FIRST_PERSON)){
                ...
                if(wind_runes){
                    ClipStack.globalInstance.addWindow(re.getStack(),new Rectangle(1,1,1000,1000));
                    Renderer2d.renderTexture(re.getStack(), new Identifier(LightWithin.MOD_ID, "textures/lights/runes/wind_light_runes.png"), center_x-(435/scale_factor)/2, center_y-(160/scale_factor)/2, (400/scale_factor)*1.2, (160/scale_factor)*1.2);
                    ClipStack.globalInstance.popWindow();
                }
                if(aqua_runes){
                    ClipStack.globalInstance.addWindow(re.getStack(),new Rectangle(1,1,1000,1000));
                    Renderer2d.renderTexture(re.getStack(), new Identifier(LightWithin.MOD_ID, "textures/lights/runes/aqua_light_runes.png"), center_x-(435/scale_factor)/2, center_y-(160/scale_factor)/2, (400/scale_factor)*1.2, (160/scale_factor)*1.2);
                    ClipStack.globalInstance.popWindow();
                }
                if(frog_runes){
                    ClipStack.globalInstance.addWindow(re.getStack(),new Rectangle(1,1,1000,1000));
                    Renderer2d.renderTexture(re.getStack(), new Identifier(LightWithin.MOD_ID, "textures/lights/runes/frog_light_runes.png"), center_x-(435/scale_factor)/2, center_y-(160/scale_factor)/2, (400/scale_factor)*1.2, (160/scale_factor)*1.2);
                    ClipStack.globalInstance.popWindow();
                }
            }
        });
