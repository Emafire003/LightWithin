...
public class RunesRenderer {
    ...
    public static void render(InnerLightType type, DrawContext drawContext){
        ...
        Renderer2d.renderTexture(drawContext.getMatrices(), LightWithin.getIdentifier("textures/lights/runes/"+ type.toString().toLowerCase() + "_light_runes.png"), center_x-width/2, center_y-height/2, width, height);
        ClipStack.popWindow();
    }
