...
public class TargetItemRenderer {
    ...
    public static void render(TargetType targetType, MatrixStack matrixStack){
        ...
        Renderer2d.renderTexture(matrixStack, new Identifier(LightWithin.MOD_ID, "textures/lights/ingredients/target/" + targetType.toString().toLowerCase() + ".png"), center_x-length/2, center_y-length/2, length, length);
