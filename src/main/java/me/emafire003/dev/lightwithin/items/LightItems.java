...
public class LightItems {
    ...
    public static final Item BOTTLED_LIGHT = registerItem("bottled_light",
            new BottledLightItem(new FabricItemSettings().rarity(Rarity.RARE).maxCount(1).group(ItemGroup.BREWING)));

    public static final Item LUXINTUS_BERRY_POWDER = registerItem("luxintus_berry_powder",
            new Item(new FabricItemSettings().rarity(Rarity.EPIC).maxCount(64).group(ItemGroup.BREWING)));
