...
public class LightParticlesUtil {
    ...
    public static void spawnSnowflake(ServerPlayerEntity player, Vec3d pos){
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.6875 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.6875 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.6875 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.6875 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.5625 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.5625 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.5625 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.5625 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.4375 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.4375 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.4375 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.4375 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.3125 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.3125 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.3125 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.3125 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.1875 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.1875 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.1875 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.1875 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.0625 ,pos.y+0, pos.z+-0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.0625 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.0625 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.0625 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.0625 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.0625 ,pos.y+0, pos.z+0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+2.0625 ,pos.y+0, pos.z+0.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.9375 ,pos.y+0, pos.z+-0.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.9375 ,pos.y+0, pos.z+-0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.9375 ,pos.y+0, pos.z+-0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.9375 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.9375 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.9375 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.9375 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.9375 ,pos.y+0, pos.z+0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.9375 ,pos.y+0, pos.z+0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.9375 ,pos.y+0, pos.z+0.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.9375 ,pos.y+0, pos.z+0.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.8125 ,pos.y+0, pos.z+-0.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.8125 ,pos.y+0, pos.z+-0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.8125 ,pos.y+0, pos.z+-0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.8125 ,pos.y+0, pos.z+-0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.8125 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.8125 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.8125 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.8125 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.8125 ,pos.y+0, pos.z+0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.8125 ,pos.y+0, pos.z+0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.8125 ,pos.y+0, pos.z+0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.8125 ,pos.y+0, pos.z+0.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.8125 ,pos.y+0, pos.z+0.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+-1.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+-1.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+-1.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+-1.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+-0.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+-0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+-0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+-0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+0.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+0.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+1.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+1.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.6875 ,pos.y+0, pos.z+1.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.5625 ,pos.y+0, pos.z+-2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.5625 ,pos.y+0, pos.z+-1.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.5625 ,pos.y+0, pos.z+-1.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.5625 ,pos.y+0, pos.z+-1.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.5625 ,pos.y+0, pos.z+-1.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.5625 ,pos.y+0, pos.z+-0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.5625 ,pos.y+0, pos.z+-0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.5625 ,pos.y+0, pos.z+-0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.5625 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.5625 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.5625 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.5625 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.5625 ,pos.y+0, pos.z+0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.5625 ,pos.y+0, pos.z+0.4375, 1, 0, 0, 0, 0);
        ...
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.5625 ,pos.y+0, pos.z+1.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.5625 ,pos.y+0, pos.z+2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.5625 ,pos.y+0, pos.z+2.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+-2.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+-2.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+-2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+-1.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+-1.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+-1.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+-1.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+-1.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+-1.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+-0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+-0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+0.4375, 1, 0, 0, 0, 0);
        ...
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+2.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.4375 ,pos.y+0, pos.z+2.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+-2.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+-2.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+-2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+-1.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+-1.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+-1.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+-1.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+-1.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+-1.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+1.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+1.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+1.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+1.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+1.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+1.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+2.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.3125 ,pos.y+0, pos.z+2.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+-2.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+-2.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+-2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+-1.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+-1.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+-1.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+-1.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+-1.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+-1.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+-1.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+-1.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+1.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+1.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+1.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+1.5625, 1, 0, 0, 0, 0);
        ...
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+2.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.1875 ,pos.y+0, pos.z+2.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+-2.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+-2.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+-2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+-1.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+-1.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+-1.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+-1.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+-1.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+-1.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+-1.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+-1.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+-0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+1.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+1.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+1.4375, 1, 0, 0, 0, 0);
        ...
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+2.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+1.0625 ,pos.y+0, pos.z+2.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+-2.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+-2.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+-2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+-1.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+-1.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+-1.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+-1.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+-1.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+-1.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+-1.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+-1.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+-0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+-0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+-0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+0.4375, 1, 0, 0, 0, 0);
        ...
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.9375 ,pos.y+0, pos.z+2.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+-2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+-1.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+-1.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+-1.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+-1.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+-1.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+-1.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+-1.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+-1.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+-0.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+-0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+-0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+-0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+0.4375, 1, 0, 0, 0, 0);
        ...
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+1.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.8125 ,pos.y+0, pos.z+2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+-1.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+-1.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+-1.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+-1.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+-1.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+-1.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+-1.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+-0.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+-0.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+-0.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+-0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+-0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+-0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+0.4375, 1, 0, 0, 0, 0);
        ...
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+1.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.6875 ,pos.y+0, pos.z+1.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+-2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+-1.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+-1.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+-1.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+-1.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+-1.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+-1.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+-1.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+-1.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+-0.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+-0.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+-0.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+-0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+-0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+-0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+0.4375, 1, 0, 0, 0, 0);
        ...
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+1.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.5625 ,pos.y+0, pos.z+2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+-2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+-1.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+-1.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+-1.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+-1.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+-1.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+-1.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+-1.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+-1.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+-0.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+-0.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+-0.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+-0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+-0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+-0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+-0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+0.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+0.4375, 1, 0, 0, 0, 0);
        ...
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+1.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.4375 ,pos.y+0, pos.z+2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+-2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+-1.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+-1.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+-1.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+-1.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+-1.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+-0.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+-0.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+-0.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+-0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+-0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+-0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+-0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+0.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+0.5625, 1, 0, 0, 0, 0);
        ...
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+1.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.3125 ,pos.y+0, pos.z+2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+-2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+-1.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+-1.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+-1.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+-0.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+-0.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+-0.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+-0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+-0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+-0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+0.6875, 1, 0, 0, 0, 0);
        ...
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+0.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+1.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+1.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+1.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+1.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.1875 ,pos.y+0, pos.z+2.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.0625 ,pos.y+0, pos.z+-1.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.0625 ,pos.y+0, pos.z+-1.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.0625 ,pos.y+0, pos.z+-1.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.0625 ,pos.y+0, pos.z+-0.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.0625 ,pos.y+0, pos.z+-0.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.0625 ,pos.y+0, pos.z+-0.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.0625 ,pos.y+0, pos.z+-0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.0625 ,pos.y+0, pos.z+-0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.0625 ,pos.y+0, pos.z+-0.3125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.0625 ,pos.y+0, pos.z+0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.0625 ,pos.y+0, pos.z+0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.0625 ,pos.y+0, pos.z+0.6875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+0.0625 ,pos.y+0, pos.z+0.8125, 1, 0, 0, 0, 0);
        ...
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+-0.1875 ,pos.y+0, pos.z+-1.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+-0.1875 ,pos.y+0, pos.z+-1.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+-0.1875 ,pos.y+0, pos.z+-1.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+-0.1875 ,pos.y+0, pos.z+-1.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+-0.1875 ,pos.y+0, pos.z+-0.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+-0.1875 ,pos.y+0, pos.z+-0.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+-0.1875 ,pos.y+0, pos.z+-0.6875, 1, 0, 0, 0, 0);
        ...
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+-0.8125 ,pos.y+0, pos.z+0.4375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+-0.8125 ,pos.y+0, pos.z+0.5625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+-0.8125 ,pos.y+0, pos.z+0.8125, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+-0.8125 ,pos.y+0, pos.z+0.9375, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+-0.8125 ,pos.y+0, pos.z+1.0625, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+-0.8125 ,pos.y+0, pos.z+1.1875, 1, 0, 0, 0, 0);
        player.getWorld().spawnParticles(player, ParticleTypes.SNOWFLAKE, false, pos.x+-0.8125 ,pos.y+0, pos.z+1.3125, 1, 0, 0, 0, 0);
