...
public class LightParticles {
    ...
    public static void registerParticles() {
        ...
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(LightWithin.MOD_ID, "light_particle"),
                LIGHT_PARTICLE);

        Registry.register(Registry.PARTICLE_TYPE, new Identifier(LightWithin.MOD_ID, "shine_particle"),
                SHINE_PARTICLE);
    }
}
