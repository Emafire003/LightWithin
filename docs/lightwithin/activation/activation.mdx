...
From version 1.1.0 you are able to activate your light on-demand using Light Charges as well, with some drawbacks tho. For more info look at the dedicated page.
...
### Conditions
The conditions can be factors of even more danger for a player or "catalysts" for that player's light type.situations
These all have different weights, and contribute to a threshold which if surpassed, allows the activation of the light.
The combination of all the different conditions vary between light types and even from one target type to the other, so please check them out in the dedicated page. Or discover them through playing!
...
You can find a list of the triggers in the next pages!

### Using a Luxintus berry
There is a rare item that you can find in loot chests called Luxintus Berry TODO PUT THE ASSET HERE TOO, which allows you to instantly activate your light after you have finished eating it. More info in the "Items" page.
