...
<div align="center"> <Asset width={408} height={240} location="lightwithin:stuff/charge_compare" title="Light Charge glowing comparison"/> </div>
...
To obtain this bottle there are two methods, which you can find in the [Bottled Light](items_and_misc/bottled_light) page.
