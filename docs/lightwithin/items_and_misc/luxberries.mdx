...
This one, will "mix up" your innerlight, allowing you to change its type. The change is random, and it won't be the same one you had before eating it. It will also change the target randomly, as long as it's compatible with the new light type. It is very rare.
