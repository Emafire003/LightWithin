...
Moreover, there is chance (10%) to make a critical hit. If this happens, the target is set on fire for more time and will recive more damage (configurable in the config file). A fire ring will also appear around the player, and a column of fire particles will spawn on the targets. A custom audio will also be played.
