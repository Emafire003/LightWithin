...
**Effect:**
- **`ALL`**: When activated, a number of frog equal to the the power multiplier + a random amount between 0 and 5 will spawn. With the color of the frogs being random. Everyone in the area will be damaged by magic of an amount equal to the number of frog spawned. Yes, pretty weird. Particles of Frog Light will also spawn.
